# frontend-tao / bem
Это инструмент, предназначен для описания поведения DOM элемента в BEM терминологии.
...
#### asBlock(blockName)
Если в верстке используются миксины bem-блоков, то с помощью этого метода можно получить эзлемпляр класса миксованного 
блока
``` html
